      ...
      <main className="flex-1 bg-[#101010] overflow-y-auto w-full lg:w-auto lg:ml-64 lg:rounded-tl-lg">
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            ...
            <div className="border border-[#262626] rounded-lg px-6 py-4 bg-transparent">
              <div className="text-sm text-[#9ca3af] mb-2">Approved Assessment Tests</div>
              <div className="text-2xl font-semibold text-[#f9fafb]">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-[#9ca3af] mb-6">
              View and manage pending requests from your clients. Upload PDFs for assessment tests or approve consultations.
            </p>
            {error && (
          ...
          {/* Approved Assessment Tests and Session Requests Section */}
          {approvedRequests.length > 0 && (
            <div className="mb-6">
              <h2 className="text-[15px] font-semibold text-[#f9fafb] mb-1">
                Approved Assessment Tests and Session Requests
              </h2>
              <p className="text-[13px] text-[#9ca3af] mb-6">
                View all approved requests and assessment tests.
              </p>
              <SessionRequestList
