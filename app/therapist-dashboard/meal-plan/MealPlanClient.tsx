    ...
    <div className="p-8">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <div>
            <h1 className="text-[15px] font-semibold text-[#f9fafb] mb-1">Assessment Tests</h1>
            <p className="text-[13px] text-[#9ca3af]">
              Manage assessment tests for your clients.
            </p>
          </div>
          <Button
      ...
      {/* Sent Assessment Tests Section */}
      <div>
        <h2 className="text-sm font-semibold text-[#f9fafb] mb-4">Sent Assessment Tests</h2>
        {sentPlans.length > 0 ? (
          <div className="space-y-4">
            {sentPlans.map((plan) => (
              <div
          ...
          <div className="text-center py-12 border border-[#262626] rounded-lg">
            <p className="text-sm text-[#9ca3af]">No sent assessment tests yet.</p>
          </div>
        )}
      </div>
